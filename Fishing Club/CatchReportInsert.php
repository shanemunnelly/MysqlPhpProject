...
$IngCatchWeight = $_POST['IngCatchWeight'];

$memCatchConditions = $_POST['memCatchConditions'];
...
mysqli_query($conn, "INSERT INTO CATCHREPORT (IngMemNumber, intSwimNumber, CatchSpeciesID, IngCatchWeight, memCatchConditions,IngCatchTagID ) VALUES ('$IngMemNumber', '$intSwimNumber', '$CatchSpeciesID', '$IngCatchWeight', '$memCatchConditions', '$IngCatchTagID' )");
