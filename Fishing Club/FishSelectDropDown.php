...
<?php
$myData = mysqli_query($conn, "SELECT * FROM FISH");
		while($record = mysqli_fetch_array($myData)){
			echo '<option value="' . $record['CatchSpeciesID ']. '.' . $record['CatchSpeciesDescription']. '.' . $record['CatchSpeciesDetails']. '">' .$record['CatchSpeciesID']. ' | '.$record['CatchSpeciesDescription']. ' | '.$record['CatchSpeciesDetails'].  ' | '. '</option>';
